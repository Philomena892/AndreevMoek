...
import sys
import csv
from node import Node, read_file, benchmark
...
def main(raw_args=None):
    '''
    Runs greedy-CBS on the specified input file. Returns a suboptimal solution.

    usage: node_greedy.py [-h] [-b] -hz HORIZON input [benchmark_file]
